<script lang="ts">
  ...
  import { CircleX, LogOut, ShieldCheck } from "lucide-svelte";
  ...
  <Table.Root class="w-full border border-primary">
    <Table.Header>
      <Table.Row>
        ...
        <Table.Head class="text-center w-1">Supprimer</Table.Head>
      </Table.Row>
    </Table.Header>
    <Table.Body>
      {#each group_store.groups as [_, group]}
        <Table.Row>
          ...
          <Table.Cell>
            <div class="flex justify-center">
              <Button variant="secondary" onclick={() => console.log(group)}>
                <LogOut />
              </Button>
            </div>
          </Table.Cell>
